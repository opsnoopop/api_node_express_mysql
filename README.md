...
A simple Node Express API application and MySQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_node_express_mysql.git
```

### 2. Navigate to Project Directory
```bash
cd api_node_express_mysql
```
